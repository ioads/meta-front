<template>
  ...
  <div class="flex-1 p-10 text-2xl font-bold">
    <div class="flex flex-col text-left">
        ...
        <div class="py-5">
            <button class="bg-yellow-500 rounded-md w-40 text-white">
                Voltar
            </button>
        </div>
        ...
        <div class="py-5">
            <form class="w-full max-w-lg" method="post">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <select v-model="category" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text">
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            axios
            .post('http://localhost:8000/api/products/'+this.$route.params.id, {description: this.description, category_id: this.test})
            .then(() => {
