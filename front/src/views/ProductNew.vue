        ...
        <div class="py-5">
            <form class="w-full max-w-lg" method="post">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <select v-model="selected" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text">
...
export default {
    ...
    methods: {
        ...
        save() {
            axios
            .post('http://localhost:8000/api/products', {description: this.description, category_id: this.selected})
            .then(() => {
